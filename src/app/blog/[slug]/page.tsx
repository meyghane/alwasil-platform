...
function renderBlock(block: ArticleBlock, i: number) {
 ...
 case 'intro':
 return (
 <p key={i} style={{ fontSize: '1.05rem', lineHeight: 1.75, color: '#374151', borderLeft: '3px solid #7652CA', paddingLeft: '1.25rem', margin: '0 0 2rem' }}>
 {block.content}
 </p>
 );
 case 'h2':
 ...
 <div>
 <p style={{ fontWeight: 700, color: '#7652CA', marginBottom: '0.4rem', fontSize: '0.9rem' }}>{block.title}</p>
 ...
 <div>
 <p style={{ fontWeight: 700, color: '#7652CA', marginBottom: '0.2rem', fontSize: '0.95rem' }}>{block.label}</p>
 {block.desc && <p style={{ color: '#64748b', fontSize: '0.825rem', margin: 0 }}>{block.desc}</p>}
 </div>
 <Link href={block.href} style={{ padding: '0.55rem 1.25rem', backgroundColor: '#7652CA', color: 'white', borderRadius: '8px', textDecoration: 'none', fontWeight: 600, fontSize: '0.875rem', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', gap: '0.4rem', flexShrink: 0 }}>
...
export default async function ArticlePage({ params }: { params: Promise<{ slug: string }> }) {
 ...
 <span style={{ color: '#7652CA', fontWeight: 500 }}>Al-Wasil</span>
 </div>

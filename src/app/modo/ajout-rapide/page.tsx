...
export default function AjoutRapidePage() {
 ...
 const confColor = conf && conf >= 80 ? '#7652CA' : conf && conf >= 60 ? '#d97706' : '#dc2626';

 return (
 <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0ebfa 0%, #faf9ff 100%)' }}>
 ...
 <div style={{ backgroundColor: 'white', borderRadius: '20px', border: '1px solid #f0ebfa', overflow: 'hidden', boxShadow: '0 4px 24px rgba(124,58,237,0.08)', marginBottom: '1rem' }}>

 {/* Bandeau Wassil */}
 <div style={{ background: 'linear-gradient(135deg, #7652CA, #543398)', padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
 ...
 style={{ width: '100%', padding: '1rem', border: '2px solid #f0ebfa', borderRadius: '12px', fontSize: '0.92rem', outline: 'none', resize: 'vertical', fontFamily: 'Poppins, sans-serif', lineHeight: 1.6, boxSizing: 'border-box', color: '#080808', backgroundColor: '#faf9ff' }}
 />
 ...
 placeholder="https://..."
 style={{ width: '100%', padding: '0.75rem 1rem', border: '2px solid #f0ebfa', borderRadius: '10px', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box', fontFamily: 'Poppins, sans-serif', backgroundColor: '#faf9ff' }}
 />
 </div>

 {/* Exemples */}
 <div style={{ marginTop: '1rem', padding: '0.875rem 1rem', backgroundColor: '#f0ebfa', borderRadius: '10px', border: '1px solid #f0ebfa' }}>
 <div style={{ fontSize: '0.72rem', fontWeight: 700, color: '#7652CA', marginBottom: '0.35rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Exemples rapides</div>
 {[
 ...
 {/* Contenu généré */}
 <div style={{ backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa', overflow: 'hidden', boxShadow: '0 4px 16px rgba(124,58,237,0.08)', marginBottom: '1.5rem' }}>
 <div style={{ background: 'linear-gradient(135deg, #7652CA, #543398)', padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
 <div>
 ...
 <tr key={String(k)} style={{ borderBottom: '1px solid #f0ebfa' }}>
 <td style={{ padding: '6px 0', fontWeight: 700, color: '#6b7280', width: 120 }}>{String(k)}</td>
 <td style={{ padding: '6px 0', color: '#080808' }}>
 {String(k) === 'Site web' ? (
 ...
 {fiche.note_djamil && (
 <div style={{ marginTop: '1rem', padding: '0.875rem', backgroundColor: '#f0ebfa', borderRadius: '10px', border: '1px solid #f0ebfa' }}>
 ...
 <a href="/admin/soumissions" style={{ flex: 1, padding: '0.875rem', background: 'linear-gradient(135deg, #7652CA, #543398)', color: 'white', borderRadius: '12px', fontWeight: 700, fontSize: '0.9rem', textAlign: 'center', textDecoration: 'none', fontFamily: 'Poppins, sans-serif' }}>
 Voir dans les soumissions →
 </a>
 <button onClick={() => { setStatus('idle'); setTexte(''); setUrl(''); setFiche(null); }}
 style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', padding: '0.875rem 1.25rem', backgroundColor: '#f0ebfa', color: VIOLET, border: '2px solid #f0ebfa', borderRadius: '12px', fontWeight: 700, fontSize: '0.9rem', cursor: 'pointer', fontFamily: 'Poppins, sans-serif' }}>

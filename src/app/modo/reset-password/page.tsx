...
function ResetForm() {
 ...
 <CheckCircle size={48} color="#7652CA" strokeWidth={1.6} style={{ margin: '0 auto 1rem', display: 'block' }} />
 ...
 style={{ padding: '0.75rem 2rem', background: 'linear-gradient(135deg, #7652CA, #543398)', color: 'white', border: 'none', borderRadius: '10px', fontWeight: 700, cursor: 'pointer', fontFamily: 'Poppins, sans-serif' }}>
 ...
 style={{ padding: '0.875rem', background: 'linear-gradient(135deg, #7652CA, #543398)', color: 'white', border: 'none', borderRadius: '12px', fontWeight: 700, fontSize: '0.95rem', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'Poppins, sans-serif', marginTop: '0.25rem', opacity: loading ? 0.7 : 1 }}>
...
export default function ResetPasswordPage() {
 ...
 <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 52, height: 52, background: 'linear-gradient(135deg, #7652CA, #543398)', borderRadius: '14px', marginBottom: '0.75rem' }}>

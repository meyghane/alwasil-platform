...
export const SPECIALITE_LABELS: Record<LibrairieSpecialite, string> = {
 ...
 'arabe': 'Langue arabe',
 'enfants': 'Enfants',
 'histoire-islam': 'Histoire islamique',
...
export const librairies: Librairie[] = [
 ...
 {
 id: 'lib11',
 name: 'Librairie Islamique de Créteil',
 type: 'physique',
 description: 'Librairie islamique incontournable du Val-de-Marne. Large choix de livres en français et en arabe, Corans, manuels d\'arabe pour tous niveaux, vêtements islamiques, accessoires et parfums. Service accueillant et conseils personnalisés.',
 ville: 'Créteil',
 department: '94',
 horaires: 'Lun–Sam 9h30–19h30',
 fermeture: 'Dimanche fermé',
 maps: '#',
 specialites: ['coran-tafsir', 'arabe', 'livres-francais', 'enfants', 'vetements', 'accessoires', 'parfums-huiles'],
 langues: ['Français', 'Arabe'],
 tags: ['créteil', '94', 'val-de-marne', 'accessoires', 'parfums'],
 featured: false,
 online: false,
 livraison: false,
 rating: 4.5,
 ...
 {
 id: 'lib12',
 name: 'Librairie El Bana',
 type: 'physique',
 description: 'Librairie islamique du Val-d\'Oise, connue pour sa sélection variée de livres islamiques en français et en arabe, ses Corans de qualité et ses accessoires de prière. Un espace de référence pour la communauté du 95.',
 ville: 'Val-d\'Oise',
 department: '95',
 horaires: 'Lun–Sam 9h30–19h',
 maps: '#',
 specialites: ['coran-tafsir', 'arabe', 'livres-francais', 'accessoires', 'enfants'],
 langues: ['Français', 'Arabe'],
 tags: ['el-bana', '95', 'val-d-oise', 'coran', 'accessoires'],
 featured: false,
 online: false,
 livraison: false,
 rating: 4.4,

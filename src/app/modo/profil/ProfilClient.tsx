...
export default function ProfilClient({
 ...
 return (
 <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f0ebfa 0%, #faf9ff 100%)', fontFamily: 'Poppins, sans-serif' }}>
 ...
 {/* Avatar */}
 <div style={{ width: 64, height: 64, borderRadius: '18px', background: 'linear-gradient(135deg, #7652CA, #543398)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.5rem', fontWeight: 900, color: 'white', flexShrink: 0, boxShadow: '0 4px 16px rgba(124,58,237,0.4)' }}>
 ...
 <span style={{ fontSize: '0.68rem', fontWeight: 700, padding: '3px 8px', borderRadius: '6px', backgroundColor: 'rgba(196,181,253,0.15)', color: '#c9b6ec', border: '1px solid rgba(196,181,253,0.2)' }}>
 {session.role === 'admin' ? ' Administrateur' : ' Modérateur'}
 </span>
 {session.permissions.includes('all') ? (
 <span style={{ fontSize: '0.68rem', fontWeight: 700, padding: '3px 8px', borderRadius: '6px', backgroundColor: 'rgba(196,181,253,0.15)', color: '#c9b6ec' }}>Accès complet</span>
 ...
 <div style={{ height: '100%', width: `${level.progress}%`, background: 'linear-gradient(90deg, #7652CA, #fbbf24)', borderRadius: '99px', transition: 'width 0.6s ease' }} />
 </div>
 ...
 {[
 { label: 'Soumises', value: stats.soumises, icon: FileText, color: '#7652CA', bg: '#f0ebfa' },
 { label: 'Validées', value: stats.validees, icon: CheckCircle, color: '#7652CA', bg: '#f0fdf4' },
 ...
 <div key={label} style={{ backgroundColor: 'white', borderRadius: '14px', border: '1px solid #f0ebfa', padding: '1rem', textAlign: 'center', boxShadow: '0 2px 8px rgba(109,40,217,0.06)' }}>
 ...
 {/* Gains par action */}
 <div style={{ backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa', padding: '1.25rem', marginBottom: '1.5rem', boxShadow: '0 2px 8px rgba(109,40,217,0.06)' }}>
 ...
 {[
 { action: 'Ajouter une fiche manuellement', gain: '+10 ', color: '#7652CA' },
 { action: 'Ajout Rapide avec Wassil', gain: '+15 ', color: '#543398' },
 { action: 'Fiche validée par l\'admin', gain: '+25 ', color: '#7652CA' },
 { action: 'Valider une soumission', gain: '+5 ', color: '#6540b5' },
 ].map(({ action, gain, color }) => (
 <div key={action} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.5rem 0', borderBottom: '1px solid #f0ebfa' }}>
 ...
 <div style={{ backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa', overflow: 'hidden', boxShadow: '0 2px 8px rgba(109,40,217,0.06)' }}>
 <div style={{ display: 'flex', borderBottom: '1px solid #f0ebfa' }}>
 ...
 style={{ flex: 1, padding: '0.75rem 1rem', border: '2px solid #f0ebfa', borderRadius: '10px', fontSize: '0.9rem', outline: 'none', fontFamily: 'Poppins, sans-serif' }} />
 <button onClick={saveName} disabled={savingName}
 style={{ padding: '0.75rem 1.25rem', backgroundColor: nameOk ? '#7652CA' : VIOLET, color: 'white', border: 'none', borderRadius: '10px', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer', whiteSpace: 'nowrap', fontFamily: 'Poppins, sans-serif', transition: 'background 0.2s' }}>
 ...
 style={{ width: '100%', padding: '0.75rem 1rem', border: '2px solid #f0ebfa', borderRadius: '10px', fontSize: '0.9rem', outline: 'none', boxSizing: 'border-box', fontFamily: 'Poppins, sans-serif' }} />
 </div>
 ))}
 {pwdStatus !== 'idle' && (
 <div style={{ padding: '0.75rem', borderRadius: '8px', fontSize: '0.85rem', backgroundColor: pwdStatus === 'ok' ? '#f0ebfa' : '#fee2e2', color: pwdStatus === 'ok' ? '#543398' : '#991b1b' }}>{pwdMsg}</div>
 )}
 ...
 {/* Niveaux */}
 <div style={{ marginTop: '1.5rem', backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa', padding: '1.25rem', boxShadow: '0 2px 8px rgba(109,40,217,0.06)' }}>
 ...
 { label: 'Mousāhim', ar: 'مساهم', min: 75, max: 200, color: '#6540b5' },
 { label: 'Nāfi\'', ar: 'نافع', min: 200, max: 500, color: '#7652CA' },
 { label: 'Bâtisseur', ar: 'بانٍ', min: 500, max: 1000, color: '#7652CA' },
 ...
 return (
 <div key={label} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.6rem 0.75rem', borderRadius: '8px', marginBottom: '0.35rem', backgroundColor: isCurrentLevel ? '#f0ebfa' : 'transparent', border: isCurrentLevel ? '1px solid #e2d7f5' : '1px solid transparent' }}>

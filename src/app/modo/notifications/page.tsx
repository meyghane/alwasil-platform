...
export default async function NotificationsPage() {
 ...
 <Bell size={15} color="#c9b6ec" strokeWidth={1.8} />
 ...
 {notifs.length === 0 ? (
 <div style={{ textAlign: 'center', padding: '4rem', color: '#9ca3af', backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa' }}>
 <Bell size={32} color="#e2d7f5" strokeWidth={1.4} style={{ display: 'block', margin: '0 auto 1rem' }} />
 ...
 return (
 <div key={i} style={{ backgroundColor: 'white', borderRadius: '12px', border: `1px solid ${isPubli ? '#e2d7f5' : '#fecaca'}`, padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
 <div style={{ width: 40, height: 40, borderRadius: '10px', backgroundColor: isPubli ? '#f0ebfa' : '#fee2e2', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
 {isPubli
 ? <CheckCircle size={20} color="#7652CA" strokeWidth={2} />
 ...
 <span style={{ fontSize: '0.68rem', fontWeight: 700, padding: '3px 8px', borderRadius: '4px', backgroundColor: isPubli ? '#f0ebfa' : '#fee2e2', color: isPubli ? '#543398' : '#991b1b' }}>

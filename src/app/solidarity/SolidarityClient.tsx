...
type SolidarityClientProps = {
 cagnottes: Cagnotte[];
 initiatives: Initiative[];
 visiteMalades: VisiteMalade[];
 voyagesHumanitaires: VoyageHumanitaire[];
...
export default function SolidarityClient({
 cagnottes,
 initiatives,
 visiteMalades,
 voyagesHumanitaires,
 ...
 Des voyages organisés pour aller aider là où c&apos;est le plus nécessaire. Distribution alimentaire, chantiers solidaires, soutien psychosocial. Cliquez pour vous inscrire directement auprès de l&apos;organisateur.
 </div>
 ...
 Associations, ONG et plateformes où vous pouvez vous engager, donner ou participer. Liens directs vers leurs pages officielles.
 </div>

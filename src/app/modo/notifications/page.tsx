  ...
  return (
    <div style={{ minHeight: '100vh', background: 'linear-gradient(160deg, #f5f3ff 0%, #faf9ff 100%)' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #3b0764 0%, #1e0545 100%)', borderBottom: '1px solid rgba(196,181,253,0.15)' }}>
        <div className="container" style={{ padding: '1rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <Bell size={15} color="#c4b5fd" strokeWidth={1.8} />
      ...
      <div className="container" style={{ padding: '2rem 1rem', maxWidth: '760px' }}>
        ...
        {notifs.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '4rem', color: '#9ca3af', backgroundColor: 'white', borderRadius: '16px', border: '1px solid #ede9fe' }}>
            <Bell size={32} color="#ddd6fe" strokeWidth={1.4} style={{ display: 'block', margin: '0 auto 1rem' }} />
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {notifs.map((n: { id: string; action: string; categorie: string; nom: string; date: string; par: string }, i: number) => {
              ...
              return (
                <div key={i} style={{ backgroundColor: 'white', borderRadius: '12px', border: `1px solid ${isPubli ? '#bbf7d0' : '#fecaca'}`, padding: '1rem 1.25rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <div style={{ width: 40, height: 40, borderRadius: '10px', backgroundColor: isPubli ? '#d1fae5' : '#fee2e2', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    {isPubli
                  ...
                  <span style={{ fontSize: '0.68rem', fontWeight: 700, padding: '3px 8px', borderRadius: '4px', backgroundColor: isPubli ? '#d1fae5' : '#fee2e2', color: isPubli ? '#065f46' : '#991b1b' }}>

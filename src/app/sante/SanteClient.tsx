...
import type { PraticienPsy, PraticienHijama, PraticienRoqya, PraticienMedical } from '@/data/sante';
import DeptFilter from '@/components/DeptFilter';
import PageHeader from '@/components/PageHeader';

type Tab = 'psy' | 'hijama' | 'roqya' | 'medical';

type SanteClientProps = {
 psyProfiles: PraticienPsy[];
 hijamaProfiles: PraticienHijama[];
 roqyaProfiles: PraticienRoqya[];
...
export default function SanteClient({
 ...
 <strong>Rappel :</strong> Un praticien de roqya sérieux ne demande jamais de grande somme d&apos;argent et ne vous demande pas de ramener des effets personnels. Don libre = signe de sérieux.
 </div>
 <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '1.25rem' }}>
 {filteredRoqya.map(r => (

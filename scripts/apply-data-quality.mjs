...
const files = ['0006_data_quality.sql', '0008_moderation_history.sql'];
...
try {
 ...
 console.log('Migrations qualité et historique appliquées. Dates de vérification inconnues conservées à NULL.');

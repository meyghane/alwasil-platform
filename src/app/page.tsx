...
const V = {
  ...
  800: '#1e40af',
  900: '#1e3a8a',
  primary:  '#1d4ed8',   // Bleu nuit — CTA principal
  hover:    '#1e40af',
  dark:     '#0f172a',   // Titres
  text:     '#3f3f46',   // Corps
  muted:    '#71717a',   // Secondaire
  border:   '#e4e4e7',   // Hairline neutre
  borderV:  '#bfdbfe',   // Hairline bleue
  surface:  '#eff6ff',   // Fond léger bleu
...
const EVENTS = [
  { title: "Conférence : L'Éthique au Travail", date: 'Sam 28 Mars · 14h00', location: 'Grande Mosquée de Paris', organizer: 'Institut Al-Ghazali', tag: 'Conférence', color: '#1d4ed8' },
  { title: 'Maraude Solidaire — Gare du Nord', date: 'Dim 29 Mars · 19h30', location: 'Gare du Nord, Paris', organizer: 'Au Cœur de la Fraternité', tag: 'Solidarité', color: '#1e40af' },
  { title: "Webinaire : Comprendre les enjeux de l'IA", date: 'Jeu 2 Avril · 20h00', location: 'En ligne (Zoom)', organizer: 'Muslim Tech Network', tag: 'Webinaire', color: '#1e3a8a' },
];
  ...
  return (
    <div style={{ fontFamily: FONT, backgroundColor: '#fff', color: V.dark }}>
      ...
      <section style={{
        ...
        background: 'linear-gradient(150deg, #0f2444 0%, #061228 45%, #020810 100%)',
        position: 'relative',
        overflow: 'hidden',
      }}>
        ...
        <div style={{
          ...
          width: '50%', height: '75%',
          background: 'radial-gradient(ellipse at center, rgba(96,165,250,0.45) 0%, rgba(29,78,216,0.18) 45%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{
          ...
          width: '35%', height: '60%',
          background: 'radial-gradient(ellipse at center, rgba(29,78,216,0.2) 0%, transparent 65%)',
          pointerEvents: 'none',
        }} />
        ...
        {[
          ...
          <div key={i} style={{
            ...
            borderRadius: '50%', backgroundColor: '#93c5fd',
        ...
        <div className="container" style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Al-Wasil centralise <strong style={{ color: '#93c5fd' }}>tout ce que la communauté musulmane de France cherche</strong> — en un seul endroit, mis à jour par la communauté.
            </p>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
              ...
              <Link href="/contact?type=general" style={{
                ...
                backgroundColor: 'rgba(147,197,253,0.12)', color: '#93c5fd',
            ...
            {SECTIONS.slice(0, 9).map(s => (
              ...
              >
                ...
                >
                  ...
                  <s.icon size={22} color="#93c5fd" strokeWidth={1.5} />
                  <span style={{
      ...
      <section style={{
        background: 'linear-gradient(180deg, #0d1f3c 0%, #061228 100%)',
          ...
          <div className="ticker-track">
            {[...STATS, ...STATS].map((s, i) => {
              ...
              return (
                ...
                >
                  {/* Icône Lucide — tracé vert, pas d'emoji */}
                  <Icon size={14} color="#93c5fd" strokeWidth={1.8} style={{ flexShrink: 0 }} />
      ...
      <section style={{
        ...
        <div style={{
          ...
          width: '50%', height: '120%',
          background: 'radial-gradient(ellipse at center, rgba(96,165,250,0.28) 0%, rgba(29,78,216,0.1) 50%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '3.5rem' }}>
            <span style={{ fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.12em', color: '#93c5fd', textTransform: 'uppercase' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <Link href="/contact?type=general" style={{
              ...
              padding: '0.9rem 2rem',
              backgroundColor: '#fff', color: '#1e3a8a',
    ...
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Icon size={17} color="#93c5fd" strokeWidth={1.8} />
        </div>
        ...
        <h3 style={{
          ...
          {title}
          {soon && <span style={{ marginLeft: '0.5rem', fontSize: '0.6rem', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#93c5fd', verticalAlign: 'middle' }}>BIENTÔT</span>}
        </h3>

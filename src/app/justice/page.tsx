...
export default function JusticePage() {
 ...
 borderBottom: mainTab === t.key ? '2px solid #7652CA' : '2px solid transparent',
 backgroundColor: 'transparent',
 color: mainTab === t.key ? '#7652CA' : 'var(--text-secondary)',
 ...
 style={{ padding: '0.4rem 0.9rem', borderRadius: '999px', border: isActive ? '2px solid #7652CA' : '1.5px solid var(--border-color)', backgroundColor: isActive ? '#7652CA' : 'white', color: isActive ? 'white' : 'var(--text-secondary)', fontSize: '0.82rem', fontWeight: isActive ? 700 : 400, cursor: 'pointer', whiteSpace: 'nowrap', transition: 'all 0.15s' }}>
 {cat.label}
 </button>
 );
 })}
 ...
 <div style={{ flex: 1 }}>
 <span style={{ display: 'inline-block', backgroundColor: '#f3f0ff', color: '#7652CA', padding: '0.1rem 0.5rem', borderRadius: '4px', fontSize: '0.7rem', fontWeight: 700, marginBottom: '0.4rem' }}>
 ...
 <div style={{ flexShrink: 0, color: '#7652CA', marginTop: '0.25rem' }}>
 ...
 style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.75rem', color: '#7652CA', backgroundColor: '#f3f0ff', padding: '0.2rem 0.6rem', borderRadius: '4px', textDecoration: 'none' }}>
 ...
 const color = t.key !== 'all' ? LIEN_TYPE_COLORS[t.key] : '#7652CA';
 ...
 style={{ display: 'flex', alignItems: 'center', gap: '0.3rem', color: '#7652CA', fontSize: '0.8rem', fontWeight: 600, textDecoration: 'none', whiteSpace: 'nowrap' }}>
 ...
 <Link href="/contact?type=question-juridique" className="btn btn-primary" style={{ backgroundColor: '#7652CA', borderColor: '#7652CA', textDecoration: 'none' }}>

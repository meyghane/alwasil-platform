...
export default function ChatInterne({
 ...
 background: 'linear-gradient(135deg, #7652CA, #543398)',
 ...
 <span key={name} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.62rem', backgroundColor: '#f0fdf4', color: '#7652CA', padding: '1px 7px', borderRadius: '99px', border: '1px solid #e2d7f5' }}>
 ...
 {/* Avatar */}
 {!isMe && (
 <div style={{ width: 28, height: 28, borderRadius: '8px', flexShrink: 0, background: msg.role === 'admin' ? 'linear-gradient(135deg, #7652CA, #543398)' : 'linear-gradient(135deg, #6540b5, #543398)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '0.7rem', fontWeight: 700 }}>
 ...
 style={{ flex: 1, padding: '0.6rem 0.875rem', border: '1.5px solid #f0ebfa', borderRadius: '12px', fontSize: '0.85rem', outline: 'none', fontFamily: 'Poppins, sans-serif', backgroundColor: '#faf9ff' }}
 />
 <button type="submit" disabled={!input.trim() || sending}
 style={{ width: 38, height: 38, borderRadius: '10px', background: input.trim() ? 'linear-gradient(135deg, #7652CA, #543398)' : '#f3f4f6', border: 'none', cursor: input.trim() ? 'pointer' : 'not-allowed', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>

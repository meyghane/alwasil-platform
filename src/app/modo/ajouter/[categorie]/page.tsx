...
export default async function ModoAjouterPage({ params }: { params: Promise<{ categorie: string }> }) {
 ...
 <div style={{ backgroundColor: 'white', borderRadius: '16px', border: '1px solid #f0ebfa', overflow: 'hidden', boxShadow: '0 4px 20px rgba(109,40,217,0.08)' }}>
 <div style={{ background: 'linear-gradient(135deg, #7652CA 0%, #6540b5 100%)', padding: '1.25rem 1.75rem' }}>

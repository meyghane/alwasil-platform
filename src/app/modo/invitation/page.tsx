...
function InvitationForm() {
 ...
 style={{ padding: '0.9rem', background: 'linear-gradient(135deg, #7652CA, #543398)', color: 'white', border: 'none', borderRadius: '12px', fontWeight: 700, fontSize: '0.95rem', cursor: saving ? 'not-allowed' : 'pointer', fontFamily: 'Poppins, sans-serif', marginTop: '0.25rem', opacity: saving ? 0.7 : 1, boxShadow: '0 4px 16px rgba(124,58,237,0.4)' }}>
